...
class DatabaseCopyHelper(context: FragmentActivity?) : SQLiteOpenHelper(context,DB_NAME,null,1) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE TABLE IF NOT EXISTS flags (flag_id INTEGER, countryName TEXT, flagName TEXT)")
